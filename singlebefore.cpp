...
{
    int ele,p=1;
    cout<<"Enter the element after which the entered element will be inserted "<<endl;
    cin>>ele;
    for(curr=first;p<ele;p++,curr=curr->link);
    node *temp=new node;
    cout<<"Enter the data ";
    cin>>temp->data;
    temp->link=NULL;
...
void node::ins_before()
{
    ...
    int ele,p=1;
    node *j;
    cout<<"Enter the element before which the entered element will be inserted "<<endl;
    cin>>ele;
    for(curr=first;p<ele;p++,curr=curr->link)
    {
        j=curr;
